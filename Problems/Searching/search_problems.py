...
for i in range(len(word_list)):
    if word_list[i].upper() == "ALICE":
        alice_count += 1
print("Alice is printed", alice_count, "times")
...
count_list = [word_list.count(x) for x in seven_letter_list]
print(count_list)
...
print("CHESHIRE is mentioned", cheshire_count, "times")
print("CAT is mentioned", cat_count, "times")
print("CHESHIRE-CAT is mentioned", cheshirecat_count, "times")
